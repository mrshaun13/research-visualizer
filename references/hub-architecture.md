...
- **Regenerable** — Generated by the skill from templates. The skill can safely overwrite these from `hub-scaffold-templates.md` at any time. User content is never stored here.
